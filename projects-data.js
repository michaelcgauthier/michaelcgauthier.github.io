window.PROJECTS = [
...

  {
    slug: "project-2",
    number: 2,
    title: "Digitization of inspection workflows through ArcGIS, replacing paper forms",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "SolidWorks, AutoCAD, MATLAB, Arduino, 3D printing, Fusion 360, laser cutting, LED wiring, circuits, woodworking, design, prototyping, user-focused design",
    contextLabel: "What / Context",
...

  {
    ...
    subsections: [
      ...
      },
      {
        ...
        skillsLabel: "Key Skills Used",
        skills: "Charpy impact, Fracta, Rockwell hardness, optical microscopy, polished/etched, polariscope, XRD, fracture energy, phase percentage measurement, material identification",
        contextLabel: "What / Context",
      ...
      },
      {
        ...
        skillsLabel: "Key Skills Used",
        skills: "Arduino, MATLAB, RTDs, thermocouples, lux sensors, calipers, micrometers, uncertainty analysis, sensor placement, data plotting, measurement error analysis",
        contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "SolidWorks, prosthetic hand design, mechanism modeling, 3D printing, linkage geometry, assembly design, design iteration, human-centered design, prototype refinement",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "AutoCAD, intersection layout, lane geometry, traffic signal concept design, Five Whys, Six Sigma-style root cause analysis, existing conditions review, safety-focused design, presentation graphics",
    contextLabel: "What / Context",
  ...
  
  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "Python, pytesseract OCR, scanned PDF processing, file renaming automation, folder structure design, project indexing, metadata extraction, debugging, time study analysis",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "Construction documentation, field progress tracking, video editing, iMovie, Clipchamp, project sequencing, visual communication, design-to-construction documentation",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "Lesson planning, presentation design, outreach coordination, Scratch, Wix, basic web design, coding instruction, event planning, team leadership, technical communication",
    contextLabel: "What / Context",
