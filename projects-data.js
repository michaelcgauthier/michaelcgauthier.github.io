window.PROJECTS = [
  {
    ...
    skills: "Python, pytesseract OCR, image-to-vector conversion, AutoCAD drafting, ArcGIS, georeferencing, scale correction, attribute mapping, debugging, and time study",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "ArcGIS Survey123, ArcGIS Field Maps, ArcGIS Online, ESRI workflows, mobile forms, field data collection, attribute tables, contractor inspections, and network organization",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "Total station surveying, AutoCAD, 3D surface modeling, contours, datum conversion, pipe networks, plan/profile drawings, details, specifications, bid tabulation, and redline revisions.",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "AutoCAD, Civil 3D, ArcGIS, GIS-to-CAD conversion, georeferencing, utility mapping, CAD blocks, CAD points, MassDOT standards, contour generation, elevation interpolation, and coordinate systems.",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "Product design, Silhouette Studio, product assembly, machine optimization, manufacturing, workflow improvement, quality control, Wix, Etsy, customer support, and order fulfillment.",
    contextLabel: "What / Context",
...

  {
    ...
    skillsLabel: "Key Skills Used",
    skills: "SolidWorks, AutoCAD, MATLAB, Arduino, 3D printing, Fusion 360, laser cutting, LED wiring, push-button circuits, woodworking, design, prototyping, and user-focused design.",
    contextLabel: "What / Context",
